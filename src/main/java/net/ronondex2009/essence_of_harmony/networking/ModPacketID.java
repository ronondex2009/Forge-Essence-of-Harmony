...
public class ModPacketID {
    ...
    {
        INSTANCE.messageBuilder(PlayNoteC2SPacket.class, id++, NetworkDirection.PLAY_TO_SERVER).encoder(PlayNoteC2SPacket::encode).decoder(PlayNoteC2SPacket::decode).consumerMainThread(PlayNoteC2SPacket::handle).add();
    }
}
